...
export const metadata: Metadata = {
    ...
    description:
        "Request a free vallus licence: 2 users, 1 project, 1 concurrent run. A 6-month renewable term, sent by e-mail as soon as you confirm your address.",
                ...
                <section className="border-b border-line bg-ink">
                    <div className="mx-auto max-w-6xl px-6 py-20 sm:py-24">
                        ...
                        <p className="mt-4 max-w-2xl text-muted">
                            ...
                            the gated integrations. Request one below; the key is e-mailed to you as
                            soon as you confirm your address.
                        </p>
